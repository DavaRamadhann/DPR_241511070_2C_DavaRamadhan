...
<head>
    ...
    <title><?= esc($role) ?> Login - Sistem Akademik</title>
...
<div class="login-container">
    <div class="card shadow-lg border-0 login-card">
        <div class="card-body">
            <h3 class="card-title text-center mb-4"><b>SIAKAD</b> | <?= esc($role) ?> Login</h3>
            ...
            <form action="<?= site_url($formAction) ?>" method="post">
                ...
                <div class="d-grid">
                 ...
                 <div class="text-center mt-3">
                    <a href="<?= site_url('/') ?>">&laquo; Kembali ke pemilihan peran</a>
                </div>
            </form>
        </div>
    </div>
